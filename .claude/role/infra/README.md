...
| `security-reviewer` | 보안 검토 (vault + redfish auth) |

## 주의사항 (Critical)
- **vault/ 절대 보호 (rule 60)**: 모든 vault 파일은 ansible-vault encrypt 필수. 평문 commit 금지. 회전은 rotate-vault skill로만.
