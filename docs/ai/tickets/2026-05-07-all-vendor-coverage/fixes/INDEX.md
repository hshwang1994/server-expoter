...
| **M-B4** | Supermicro mock fixture (X9~X14 + AMD 시리즈) | P1 | B3 | [PENDING] | W1 | — |
| **M-C1** | Huawei iBMC adapter generation 분기 (1.x ~ 5.x) match 조건 보강 | P1 | A1 | [PENDING] | W2 | — |
| **M-C2** | redfish-gather/tasks/vendors/huawei/{collect_oem.yml, normalize_oem.yml} 신설 | P1 | C1 | [PENDING] | W2 | — |
| **M-C3** | Huawei mock fixture (FusionServer Pro / Atlas) | P1 | C2 | [PENDING] | W2 | — |
| **M-D1** | redfish-gather/tasks/vendors/inspur/{collect_oem.yml, normalize_oem.yml} 신설 | P1 | A2 | [PENDING] | W2 | — |
| **M-D2** | Inspur mock fixture (NF/NP/SA series) | P1 | D1 | [PENDING] | W2 | — |
| **M-E1** | Fujitsu iRMC S2/S4/S5/S6 generation 분기 (firmware_patterns 확장) | P1 | A3 | [PENDING] | W3 | — |
| **M-E2** | redfish-gather/tasks/vendors/fujitsu/{collect_oem.yml, normalize_oem.yml} 신설 | P1 | E1 | [PENDING] | W3 | — |
| **M-E3** | Fujitsu mock fixture (PRIMERGY / PRIMEQUEST) | P1 | E2 | [PENDING] | W3 | — |
| **M-F1** | redfish-gather/tasks/vendors/quanta/{collect_oem.yml, normalize_oem.yml} 신설 | P1 | A4 | [PENDING] | W3 | — |
| **M-F2** | Quanta mock fixture (S/D/T/J series) | P1 | F1 | [PENDING] | W3 | — |
| **M-G1** | redfish-gather/tasks/vendors/hpe/collect_oem.yml — Superdome Flex 분기 보강 (Gen 1/2 + 280) | P1 | — | [PENDING] | W3 | — |
| **M-G2** | Superdome Flex mock fixture | P1 | G1 | [PENDING] | W3 | — |
| **M-H1** | Dell idrac (legacy) / iDRAC8 / iDRAC9 — capability 검증 + origin 주석 + mock fixture | P1 | — | [PENDING] | W4 | — |
| **M-H2** | HPE iLO (legacy) / iLO4 / iLO5 / iLO6 — 동일 | P1 | — | [PENDING] | W4 | — |
| **M-H3** | Lenovo bmc / IMM / IMM2 / XCC / XCC2 — 동일 (XCC2 capability 추가 검토) | P1 | — | [PENDING] | W4 | — |
| **M-H4** | Cisco BMC / CIMC C-series 1.x ~ 4.x / S-series / B-series — 동일 | P1 | — | [PENDING] | W4 | — |
