...
- **OPS-3** 운영팀 vault credential 회전 timing
- **OPS-11** Cisco BMC 10.100.15.1 / 10.100.15.3 일시 장애 회복 (외부 운영)
- **AI-22 reopen** Win Server 2022 (10.100.64.135) 포트 closed — lab firewall / WinRM 서비스 정상 작동 OPS 조사
- **AI-19 후속** baremetal dmidecode 권한 (sudo 또는 ansible_become_pass) — 운영 정책 결정
